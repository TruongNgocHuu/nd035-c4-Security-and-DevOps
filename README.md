...
- url: where splunk redirect log: 8080
- host: splunk server
- token: security tokent to connect to splunk: 7b1705b2-2eb1-45cb-90ec-f40dcc7293f5
- index: index to push application logs: service-api-log
- source: the app which will publish logs
- 
```shell
